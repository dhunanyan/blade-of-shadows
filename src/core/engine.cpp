...
float Engine::playerPixelX() const
{
  return playerPixelX_;
}

float Engine::playerPixelY() const
{
...
void Engine::setPlayerPosition(const Position& position)
{
...
void Engine::setPlayerMoveIntentX(int intentX)
{
  if (intentX < -1)
  {
    playerMoveIntentX_ = -1;
    return;
  }
  if (intentX > 1)
  {
